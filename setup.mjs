...
const CAPS = [
  ...
  ['row', 'Приціл на БЛОК: клік → нота', 'Alt+A або кнопка'],
  ['row', 'Приціл на ВІДСТУП: клік по порожнечі → нота, у якій сказано, чим вона зроблена — gap, margin чи padding', 'Alt+S або кнопка'],
