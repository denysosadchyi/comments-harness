...
export const DEFAULTS = {
  ...
  prefix: '',
  /* Сервер нот. Порт мусить збігатися з тим, що зашитий в оверлеї
     (`overlay/annotator.tsx`) і в рев'ю-сторінці — вони конфіг не читають,
     бо виконуються в браузері. Міняєш тут — міняй і там. */
  notesPort: 4747,
  /* Сервер вердиктів і черги доробок. Те саме застереження. */
  ratingsPort: 4748,
